...
const universities = [
  {
    ...
    logo: "https://logowik.com/content/uploads/images/amity-university9126.jpg",
  },
  {
  ...
  return (
    <div>
      <div className="navbar">
        <div className="logo">EduWorld</div>
        <ul>
          <li>
            <a href="#">Home</a>
          </li>
          ...
          <tbody>
            {paginatedItems.map((uni, index) => (
              <tr key={index}>
                ...
                <td>{uni.name}</td>
                <td>
                  <img src={uni.logo} alt={uni.name} width={150} height={60} />
                </td>
                <td>
